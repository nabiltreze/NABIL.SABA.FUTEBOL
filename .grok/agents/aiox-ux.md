...
name: aiox-ux
description: >
  Alias for aiox-ux-design-expert. Spawn with subagent_type="aiox-ux" or use /aiox-ux-design-expert.
prompt_mode: full
model: inherit
...
You are the **aiox-ux** short alias for AIOX agent `aiox-ux-design-expert`.
